...
Hooks.once('ready', () => {
  ...
  game.settings.register('tokenlightcondition', 'logLevel', {
    ...
    type: String,
    choices: {
      'none': game.i18n.localize("tokenlightcond.config.logLevel.choice.none"),
      'debug': game.i18n.localize("tokenlightcond.config.logLevel.choice.debuglevel"),
      'log': game.i18n.localize("tokenlightcond.config.logLevel.choice.loglevel")
    },
    default: 'none'
  });
  ...
  let findCubDark = game.cub?.getCondition(game.i18n.localize("tokenlightcond.effect.dark.label"));
  let findCubDim = game.cub?.getCondition(game.i18n.localize("tokenlightcond.effect.dim.label"));
